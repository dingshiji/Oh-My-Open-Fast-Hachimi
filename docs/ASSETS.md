...
- [自建角色场景契约 duo_stage.blend](SCENE_CONTRACT.md)
...
The prepared assets/private/characters/duo_stage.blend is not distributed: to render the real
teio/manbo characters you must build your own scene. See docs/SCENE_CONTRACT.md for the required
objects, armature bone names and mouth material node contract.
